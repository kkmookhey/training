...
> **OWASP:** — · **Eiger layer:** L5 + full stack · **Model tier:** BYOK
...
- **Stretch:** automate — point garak / PyRIT at Eiger and produce a findings report.
...
| Phase | What happens |
|-------|--------------|
| Build | Iggy fronted by bypassable guardrails; incomplete logging |
